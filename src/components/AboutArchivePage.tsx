      ...
      <div className="max-w-[850px] mx-auto space-y-10 text-left">
        ...
        <div className="border-b border-zinc-900 pb-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 text-left">
          ...
          <div className="flex items-center gap-2 text-[9.5px] font-mono text-zinc-500 uppercase tracking-widest text-left break-words">
            <BookOpen size={14} className="text-zinc-300 shrink-0" />
            <span className="break-words">LOMON LLC • ABOUT THE ARCHIVE</span>
          </div>
        </div>
        ...
        <div className="space-y-10 text-[12.5px] leading-relaxed font-sans text-zinc-300">
          ...
          <section className="space-y-4 border-b border-zinc-900/60 pb-8 text-left">
            <h2 className="text-base sm:text-lg font-mono font-bold text-white tracking-wider uppercase text-left flex items-start gap-2 break-words">
              <span className="text-zinc-400 shrink-0">01.</span>
          ...
          <section className="space-y-4 border-b border-zinc-900/60 pb-8 text-left">
            <h2 className="text-base sm:text-lg font-mono font-bold text-white tracking-wider uppercase text-left flex items-start gap-2 break-words">
              <span className="text-zinc-400 shrink-0">02.</span>
          ...
          <section className="space-y-4 border-b border-zinc-900/60 pb-8 text-left">
            <h2 className="text-base sm:text-lg font-mono font-bold text-white tracking-wider uppercase text-left flex items-start gap-2 break-words">
              <span className="text-zinc-400 shrink-0">03.</span>
            ...
            <div className="p-3 bg-zinc-950 border border-zinc-900 text-[11.5px] font-mono text-zinc-300 rounded-sm text-left break-words">
          ...
          <section className="space-y-4 border-b border-zinc-900/60 pb-8 text-left">
            <h2 className="text-base sm:text-lg font-mono font-bold text-white tracking-wider uppercase text-left flex items-start gap-2 break-words">
              <span className="text-zinc-400 shrink-0">04.</span>
              <span>CLEARANCE</span>
            </h2>
          ...
          <section className="my-8 text-left">
            <div className="p-6 bg-zinc-950 border-l-2 border-zinc-400 border-y border-r border-zinc-900/80 rounded-sm space-y-2 text-left">
              <span className="text-[9.5px] font-mono text-zinc-500 uppercase tracking-widest block font-bold text-left">
                ARCHIVAL CREDO
              </span>
              <blockquote className="text-[13.5px] sm:text-[14.5px] font-serif italic text-zinc-200 leading-relaxed text-left">
          ...
          <section className="space-y-4 border-b border-zinc-900/60 pb-8 text-left">
            <h2 className="text-base sm:text-lg font-mono font-bold text-white tracking-wider uppercase text-left flex items-start gap-2 break-words">
              <span className="text-zinc-400 shrink-0">05.</span>
              <span>THE FUTURE OF THE ARCHIVE</span>
            </h2>
            ...
            <div className="p-4 bg-zinc-950 border border-zinc-900 text-[12px] font-mono text-white rounded-sm font-semibold text-left break-words">
              The archive is a catalogue of preserved musical moments, maintained for creators who value originality and documentation.
            </div>
          </section>

          {/* ACTION BUTTONS */}
          <section className="p-5 bg-zinc-950 border border-zinc-900 rounded-sm space-y-4 text-left">
            <div className="space-y-1 text-left">
              <span className="text-[10px] font-mono text-zinc-500 uppercase tracking-widest block font-bold text-left">
                EXPLORE &amp; CLEARANCE
              </span>
              <p className="text-[12px] font-mono text-zinc-200 font-bold uppercase text-left">
                READY TO REVIEW AVAILABLE FRAGMENTS OR INQUIRE ABOUT A COMPOSITION?
              </p>
            </div>

            <div className="flex flex-wrap items-center gap-3 pt-1 text-left">
              {onRequestClearance && (
                <button
